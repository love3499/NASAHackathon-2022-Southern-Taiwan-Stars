                    ...
                    for (var p = 0; p < pickList.objects.length; p++) {
                        ...
                        for (var eq = 0; eq < GeoJSON.features.length; eq++) {
                            if (pickList.objects[p].userObject.center &&
                                ...
                                Metadata.setName(GeoJSON.features[eq].properties.name);

                                Metadata.setEarthquake(GeoJSON.features[eq].properties.earthquake);
                                Metadata.setPrecipitation(GeoJSON.features[eq].properties.rainfall);
                                Metadata.setMudslide(GeoJSON.features[eq].properties.mudslide);
